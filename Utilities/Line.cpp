...
bool Line::LineCollision(DoubleVector2 one, DoubleVector2 two, D3DXVECTOR2& result)
{
	//D3DXVec2CCW(a,b)
	//D3DXVec2CCW(a-p, b-p)
...
bool Line::lineIntersection(D3DXVECTOR2 a, D3DXVECTOR2 b, D3DXVECTOR2 c, D3DXVECTOR2 d, D3DXVECTOR2 & p)
{
...
//Code Segment from https://bowbowbow.tistory.com/17
bool Line::paralleSegments(D3DXVECTOR2 a, D3DXVECTOR2 b, D3DXVECTOR2 c, D3DXVECTOR2 d, D3DXVECTOR2 & p)
{
	if (b < a) swap(a, b);
	if (d < c) swap(c, d);
...
//Code Segment from https://bowbowbow.tistory.com/17
bool Line::segmentIntersects(D3DXVECTOR2 a, D3DXVECTOR2 b, D3DXVECTOR2 c, D3DXVECTOR2 d)
{
